 ...
 \end{table}
    ...
    \end{figure}
     ...
     \begin{table}[t]
        ...
        \begin{tabular}
            ...
            % EPSILON Load Memory
            \multicolumn{3}{|c|}{\textbf{Epsilon Load Memory}} & \multicolumn{4}{c|}{\textbf{Epsilon Load Memory}} \\
            ...
            \multicolumn{3}{|c|}{\textbf{US Load Memory}} & \multicolumn{4}{c|}{\textbf{United States Load Memory}} \\
   ...
   \begin{table}[t]
       ...
       \begin{tabular}
           ...
           % EPSILON Save Memory
           \multicolumn{3}{|c|}{\textbf{Epsilon Save Memory}} & \multicolumn{4}{c|}{\textbf{Epsilon Save Memory}}\\
           CBP & 0.0025    & 18.8e-6 &  CBP vs XMI & -4.3e\texttt{+}6   & 21.00 & $<$ 0.001 \\
           OCBP & 0.0031    & 279.9e-6 & CBP vs OCBP & -10.131 & 21.19 & $<$ 0.001 \\ %1.41e-09 \\  
           XMI & 17.61   & 2.4e-6 & OCBP vs XMI & -295,090  &21.00  & $<$ 0.001 \\ 
           \hline 
           
           % WIKIPEDIA Save Memory
           \multicolumn{3}{|c|}{\textbf{US Save Memory}} & \multicolumn{4}{c|}{\textbf{United States Save Memory}} \\
